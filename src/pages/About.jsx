        ...
        <motion.main
            ...
            <div className="footer-heading">
                ...
                <div className="flex bg-red-400">
                    <Link to='/contact' className="pe-4"><Button text={t('contactMe')} bg={theme.tag === 'light' ? 'black' : 'white'} color={theme.colors.bg} fontWeight={600} icon={<EmailSharp sx={{ color: theme.colors.bg }} />} /></Link>

                    <a href='tel:+237690743737'>
                        <Button text={t('callMe')} bg={theme.tag === 'light' ? 'black' : 'white'} color={theme.colors.bg} fontWeight={600} icon={<Phone sx={{ color: theme.colors.bg }} />} />
                        {/* +237 690743737 */}
                    </a>
