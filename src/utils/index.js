...
const projects = [
    ...
    },
    {
        id: 7,
        name: 'Dask',
        description: "I and my team built a task management cross platform mobile application we presented at github hackhaton. We used React native, and other npm libraries for the UI. We utilized Node.js, Socket.io and related libraries to develop websocket. The database was an SQL type, SQLite. We also used firebase to bear authentication.",
